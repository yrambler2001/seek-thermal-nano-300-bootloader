/* crypto_stream.c — 80K_43X0_Bootloader (reconstructed)
 *
...
/* Seed from the embedded Key A (flash 0x14001C2C / RAM 0x1001D850). */
 ...
 * bits are zero too. (Key A yields 0x0000FFFF here; Key B yields 0x1506336F.) */
